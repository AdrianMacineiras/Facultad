...
public class Espectaculo {
	...
	public Espectaculo(Long idEspectaculo, String nombre, String descripcion, Calendar fechaEspectaculo, int duracion,
	...
	public Espectaculo(String nombre, String descripcion, Calendar fechaEspectaculo, int duracion,
			Calendar fechaLimReserva, int maxEntradas, float precioReal, float precioDescontado, float comisionVenta,
			int numEntradasRest) {
		super();
	...
	public Espectaculo(Long idEspectaculo, String nombre, String descripcion, Calendar fechaEspectaculo, int duracion,
			Calendar fechaLimReserva, float precioReal, float precioDescontado,
			int numEntradasRest) {
		super();
		this.idEspectaculo = idEspectaculo;
		this.nombre = nombre;
